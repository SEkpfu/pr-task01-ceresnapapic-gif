...
// Функция ввода данных работника
void inputWorkerData(int &hours, double &rate, double &bonus_percent) {
...
// Функции вычисления (как в задании 2)
...
int main() {
    ...
    inputWorkerData(hours, rate, bonus_percent);
